<?php 
    ...
    $sql = "SELECT id, date, temperature, humidity, pressure, dewpoint FROM letture order by id desc limit 285";
    $sql2 = "SELECT id, date, temperature, humidity, pressure, dewpoint FROM letture order by id desc limit 286, 285";
    ...
    $lasttemp = mysqli_fetch_array($conn->query("SELECT temperature FROM letture order by id desc limit 1"));
    $lasthum = mysqli_fetch_array($conn->query("SELECT humidity FROM letture order by id desc limit 1"));
    $lastdp = mysqli_fetch_array($conn->query("SELECT dewpoint FROM letture order by id desc limit 1"));
    $lastpr = mysqli_fetch_array($conn->query("SELECT pressure FROM letture order by id desc limit 1"));
    $maxtemp = mysqli_fetch_array($conn->query("SELECT MAX(temperature) FROM letture WHERE date > '$dateI' and date < '$dateF'"));
    $maxhum = mysqli_fetch_array($conn->query("SELECT MAX(humidity) FROM letture WHERE date > '$dateI' and date < '$dateF'"));
    $maxdp = mysqli_fetch_array($conn->query("SELECT MAX(dewpoint) FROM letture WHERE date > '$dateI' and date < '$dateF'"));
    $maxpr = mysqli_fetch_array($conn->query("SELECT MAX(pressure) FROM letture WHERE date > '$dateI' and date < '$dateF'"));
    $mintemp = mysqli_fetch_array($conn->query("SELECT MIN(temperature) FROM letture WHERE date > '$dateI' and date < '$dateF'"));
    $minhum = mysqli_fetch_array($conn->query("SELECT MIN(humidity) FROM letture WHERE date > '$dateI' and date < '$dateF'"));
    $mindp = mysqli_fetch_array($conn->query("SELECT MIN(dewpoint) FROM letture WHERE date > '$dateI' and date < '$dateF'"));
    $minpr = mysqli_fetch_array($conn->query("SELECT MIN(pressure) FROM letture WHERE date > '$dateI' and date < '$dateF'"));
...
<head>
    ...
    title: { text: 'Garden Weather Station Temperature' },
    ...
    title: { text: 'Garden Weather Station Humidity' },
    subtitle: { text: 'Select area to enlarge' },
    series: [{
        showInLegend: true,
        data: hum,
    ...
    title: { text: 'Garden Weather Station Pressure' },
    subtitle: { text: 'Select area to enlarge' },
    series: [{
        showInLegend: true,
        data: pr,
    ...
    title: { text: 'Garden Weather Station Dew point' },
    subtitle: { text: 'Select area to enlarge' },
    series: [{
        showInLegend: true,
        data: dp,
