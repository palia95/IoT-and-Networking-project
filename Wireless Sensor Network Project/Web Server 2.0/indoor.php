<?php 
    ...
    $sql = "SELECT id, date, temperature, humidity, dewpoint FROM indoor order by id desc limit 285";
    $sql2 = "SELECT id, date, temperature, humidity, dewpoint FROM indoor order by id desc limit 286, 285";
    ...
    $lasttemp = mysqli_fetch_array($conn->query("SELECT temperature FROM indoor order by id desc limit 1"));
    $lasthum = mysqli_fetch_array($conn->query("SELECT humidity FROM indoor order by id desc limit 1"));
    $lastdp = mysqli_fetch_array($conn->query("SELECT dewpoint FROM indoor order by id desc limit 1"));
    $maxtemp = mysqli_fetch_array($conn->query("SELECT MAX(temperature) FROM indoor WHERE date > '$dateI' and date < '$dateF'"));
    $maxhum = mysqli_fetch_array($conn->query("SELECT MAX(humidity) FROM indoor WHERE date > '$dateI' and date < '$dateF'"));
    $maxdp = mysqli_fetch_array($conn->query("SELECT MAX(dewpoint) FROM indoor WHERE date > '$dateI' and date < '$dateF'"));
    $mintemp = mysqli_fetch_array($conn->query("SELECT MIN(temperature) FROM indoor WHERE date > '$dateI' and date < '$dateF'"));
    $minhum = mysqli_fetch_array($conn->query("SELECT MIN(humidity) FROM indoor WHERE date > '$dateI' and date < '$dateF'"));
    $mindp = mysqli_fetch_array($conn->query("SELECT MIN(dewpoint) FROM indoor WHERE date > '$dateI' and date < '$dateF'"));
...
<head>
    ...
    title: { text: 'Taverna Temperature' },
